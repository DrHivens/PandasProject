...
#i could get my 2d array from here....
distinctStopIds = set()
for i in range(len(endTimeList)):
    ...
    ax = geoplot.kdeplot(selectedRowsStopID, projection=gcrs.AlbersEqualArea(),cmap='coolwarm', figsize=(10,8), fill=True)
    geoplot.polyplot(ile, ax=ax)
    plt.savefig("imgFinal/"+ str(i) + '.png')
